...
public class LabClassUI extends JFrame {
    ...
    public LabClassUI() {
        ...
        setSize(500, 500);
        try {
            URL im = new URL("https://cdn141.picsart.com/316998257070211.png");
            Image image = new ImageIcon(im).getImage();
            setIconImage(image);
        } catch (MalformedURLException e) {
            System.out.println("Replace the icon.");
        }
    ...
    private void generateAL() {
        addStudent.addActionListener(actionEvent -> {
            try {
                ...
                JOptionPane.showMessageDialog(mainPanel, "Input GPA is illegal!",
                        "Error!", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        sortStudents.addActionListener(actionEvent -> {
            try {
                ...
                JOptionPane.showMessageDialog(mainPanel, "We don't have the students",
                        "Warning!", JOptionPane.WARNING_MESSAGE);
            }
        });
    }
